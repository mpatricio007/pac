...
{
    public partial class PACModalidade : BasePage
    {
        private const string PRIMARY_KEY = "id_modalidade_compra";        
        ...
        {
            PACModalidadeCompraBLL obj = new PACModalidadeCompraBLL();
        ...
        protected void Get(int intId)
        {
            ...
            this.txtId.Text = Convert.ToString(obj.ObjEF.id_modalidade_compra);
            this.txtNome.Text = obj.ObjEF.nome;
            this.txtDescricao.Text = obj.ObjEF.descricao;
            this.ckStatus.Checked = obj.ObjEF.status;            
        }

        protected void Set(PACModalidadeCompraBLL obj)
        {            
            obj.ObjEF.id_modalidade_compra = Convert.ToInt32(this.txtId.Text);
