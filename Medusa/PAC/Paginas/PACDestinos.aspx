<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="PACDestinos.aspx.cs" Inherits="Medusa.PAC.Paginas.PACDestinos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <ContentTemplate>
       <h2>CADASTRO DE DESTINOS DO PAC</h2>  
   ...
   <div class="pesquisar">
    ...
    <asp:Panel ID="panelGrid" runat="server">
        <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="id_pac_destino" HeaderText="código">
