<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="PACModalidade.aspx.cs" Inherits="Medusa.PAC.Paginas.PACModalidade" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <h2>CADASTRO DE MODALIDADE DO PAC</h2>
    <div class="pesquisar">
    ...
    <table  class="cadastro" >
        <tr><th colspan="1">cadastro de modalidades de compras</th>
        <th colspan="1">
