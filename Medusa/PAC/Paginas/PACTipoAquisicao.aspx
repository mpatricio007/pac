<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="PACTipoAquisicao.aspx.cs" Inherits="Medusa.PAC.Paginas.PACTipoAquisicao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
       ...
       <ContentTemplate>
       <h2>CADASTRO DE TIPO DE COMPRA DO PAC</h2>
    <div class="pesquisar">
    ...
    <table  class="cadastro" >
        <tr><th colspan="1">cadastro de tipo de compra</th>
        <th colspan="1">
