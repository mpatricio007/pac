<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/Site.master" AutoEventWireup="true" CodeBehind="Interfaces.aspx.cs" Inherits="Medusa.Admin.Interfaces" %>
   ...
   <div class="conteudoDir">
    ...
    <asp:Panel ID="panelGrid" runat="server">
        <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="id_interface" HeaderText="id_interface" 
                    SortExpression="id_interface">
                <HeaderStyle HorizontalAlign="Left" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="menu" SortExpression="Menu.Nome">
                   
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("Menu.Nome") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <table  class="cadastro" >
      ...
      <tr>
        ...
        <tr>
            <td class="esquerdo">
                menu:
                <asp:CompareValidator ID="cvMenu" runat="server" ControlToValidate="ddlMenu" 
                    ErrorMessage="selecione" Operator="NotEqual" ValueToCompare="0"></asp:CompareValidator>
            </td>
            <td class="direito">
                <asp:DropDownList ID="ddlMenu" runat="server" Width="500px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
