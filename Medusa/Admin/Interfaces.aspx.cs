...
{
    public partial class Interfaces : BasePage
    {
        private const string PRIMARY_KEY = "Id_interface";
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                MenuBLL objMenu = new MenuBLL();
                this.ddlMenu.DataTextField = "Nome";
                this.ddlMenu.DataValueField = "Id_Menu";
                this.ddlMenu.DataSource = objMenu.GetAll();
                this.ddlMenu.DataBind();

                this.ddlMenu.Items.Add(new ListItem("Selecione", "0"));

                this.ddlTipo.Items.Add(new ListItem("Página"));
                this.ddlTipo.Items.Add(new ListItem("Controle"));
        ...
        {
            InterfaceBLL obj = new InterfaceBLL();
        ...
        protected void Get(int intId)
        {
            ...
            this.txtId.Text = Convert.ToString(obj.ObjEF.Id_interface);
            this.txtNome.Text = obj.ObjEF.Nome;
            this.txtDescricao.Text = obj.ObjEF.Descricao;
            this.txtUrl.Text = obj.ObjEF.Url;
            if(obj.ObjEF.Id_Menu != null)
                this.ddlMenu.SelectedValue = Convert.ToString(obj.ObjEF.Id_Menu);
            this.ddlTipo.SelectedValue = obj.ObjEF.Tipo;
        }

        protected void Set(InterfaceBLL obj)
        {
            obj.ObjEF.Id_interface = Convert.ToInt32(this.txtId.Text);
            obj.ObjEF.Nome = this.txtNome.Text;
            obj.ObjEF.Descricao = this.txtDescricao.Text;
            obj.ObjEF.Url = this.txtUrl.Text;
            obj.ObjEF.Id_Menu = Convert.ToInt32(this.ddlMenu.SelectedValue);
            obj.ObjEF.Tipo = this.ddlTipo.SelectedValue;            
        }
