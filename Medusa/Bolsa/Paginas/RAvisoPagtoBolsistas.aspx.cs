...
{
    public partial class RAvisoPagtoBolsistas : BasePage
    {
        ...
        protected void btGerarRelatorio_Click(object sender, EventArgs e)
        {
            ...
            ReportDataSource rpDS = new ReportDataSource("dsPagtos", objBLL.GetPagtosPorMesAno(this.txtMes.Text, this.txtAno.Text, "true", this.txtDataPagtoDe.Text, this.txtDataPagtoAte.Text, this.txtProjeto.Text, ControleCPF1.GetCpf()));
